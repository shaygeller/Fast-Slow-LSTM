...
net_arg.add_argument('--fast_layers', type=int, default=0, help='')
...
train_arg.add_argument('--max_epoch', type=int, default=500, help='')
...
misc_arg.add_argument('--data_path', type=str, default=os.path.join("data","ptb"))
