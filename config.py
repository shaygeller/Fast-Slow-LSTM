...
# net_arg.add_argument('--hyper_size', type=int, default=120, help='')
net_arg.add_argument('--hyper_size', type=int, default=400, help='')
# net_arg.add_argument('--embed_size', type=int, default=121, help='')
net_arg.add_argument('--embed_size', type=int, default=128, help='')
# net_arg.add_argument('--hidden_size', type=int, default=122, help='')
# net_arg.add_argument('--hidden_size', type=int, default=256, help='')
net_arg.add_argument('--num_layers', type=int, default=1, help='')
net_arg.add_argument('--fast_layers', type=int, default=4, help='')
...
train_arg.add_argument('--max_max_epoch', type=int, default=50, help='')


train_arg.add_argument('--max_step', type=int, default=1000000, help='')
train_arg.add_argument('--init_scale', type=float, default=0.01, help='')
...
train_arg.add_argument('--lr_decay_rate', type=float, default=0.01, help='')
...
misc_arg.add_argument('--data_path', type=str, default=os.path.join("data", "bible"))
# misc_arg.add_argument('--data_path', type=str, default=os.path.join("data","spam"))
